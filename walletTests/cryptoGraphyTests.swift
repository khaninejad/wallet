...
class cryptoGraphyTests: XCTestCase {
    ...
    func testPrivateKeyDeSerialize(){
        let bls_test = BLS()
        var publicKey = bls_test.GeneratePublicKey(key: "d0c6a560de2e60b6ac55386defefdf93b0c907290c2ad1b4dbd3338186bfdc68")
    ...
    func testsignatureSerialize(){
      ...
      var serialized =  bls_test.Serialize(msg: "zarb", secretkey: "d0c6a560de2e60b6ac55386defefdf93b0c907290c2ad1b4dbd3338186bfdc68")
